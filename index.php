  ...
  <div class="mbox">
    ...
    <form class="mbody" id="form-user-modal" onsubmit="return false">
      ...
      <div class="fg">
        ...
        <input type="text" id="user-username" class="fc" placeholder="e.g. teacher3"/>
        <span class="field-error" id="fe-user-username"></span>
      </div>
      <div class="fg">
        <label class="fl">Password <span id="pw-label">*</span></label>
        <input type="password" id="user-password" class="fc" placeholder="Enter password"/>
        <span class="field-error" id="fe-user-password"></span>
      </div>
      <div class="fg">
        <label class="fl">Display Name *</label>
        <input type="text" id="user-displayname" class="fc" placeholder="e.g. Juan Dela Cruz"/>
        <span class="field-error" id="fe-user-displayname"></span>
      </div>
      <div class="fg">
